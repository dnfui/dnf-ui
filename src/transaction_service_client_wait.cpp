                          ...
                          GVariant *parameters)
{
  ...
  forward_progress_line(forwarder, _("Repository signing key approval is required."));
  ...
  forward_progress_line(forwarder,
                        confirmed ? _("Repository signing key accepted.") : _("Repository signing key rejected."));
}
