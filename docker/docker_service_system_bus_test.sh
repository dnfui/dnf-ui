...
# Docker wrapper for the system bus transaction service denial smoke test.
...
CONTAINER_NAME="dnfui-service-system-bus-test"
...
color_print "$FMT_GREEN" "*** Running transaction service system bus test inside container... ***"
