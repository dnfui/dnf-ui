...
// Raw D-Bus calls used by the GUI-side transaction service client.
// This file owns connection reuse, request startup, result reads, preview reads,
// and request release.
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
bool
transaction_service_client_get_transaction_result(GDBusConnection *connection,
...
// -----------------------------------------------------------------------------
// Ask the service to start applying a prepared request.
// -----------------------------------------------------------------------------
bool
